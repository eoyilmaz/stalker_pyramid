    ...
    $.extend(Image.prototype, {
        ...
        render: function () {
            ...
            this.$file.ace_file_input(this.options.image).on('change', function () {
                let $rand = (self.$file.val() || self.$file.data('ace_input_files')) ? Math.random() + "" + (new Date()).getTime() : null;
    ...
    $.extend(Spinner.prototype, {
        ...
        activate: function () {
            if (this.$input.is(':visible')) {
                ...
                let options = $.extend({value: val}, this.options.spinner);
    ...
    $.extend(Slider.prototype, {
        ...
        activate: function () {
            if (this.$input.is(':visible')) {
                ...
                let width = this.options.slider.width || 200;
                let options = $.extend(this.options.slider, {
                    value: val,
