...
ace.general_things = function ($) {
    ...
    var check_box;
    var ace_settings_navbar = $('#ace-settings-navbar');
    ...
    if (check_box) {
        check_box.checked = ace.settings.is('navbar', 'fixed');
    }

    var ace_settings_sidebar = $('#ace-settings-sidebar');
    ...
    if (check_box) {
        check_box.checked = ace.settings.is('sidebar', 'fixed');
    }

    var ace_settings_breadcrumbs = $('#ace-settings-breadcrumbs');
    ...
    if (check_box) {
        check_box.checked = ace.settings.is('breadcrumbs', 'fixed');
    }
