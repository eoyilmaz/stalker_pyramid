...
(function (t, e) {
    ...
    function r(n, r, c) {
        ...
        var ee = this;
        ee.options = r, ee.render = u, ee.destroy = h, ee.refetchEvents = k, ee.reportEvents = O, ee.reportEventChange = L, ee.rerenderEvents = H, ee.changeView = y, ee.select = Y, ee.unselect = B, ee.prev = P, ee.next = j, ee.prevYear = I, ee.nextYear = X, ee.today = J, ee.gotoDate = V, ee.incrementDate = U, ee.formatDate = function (t,
                                                                                                                                                                                                                                                                                                                                                 e) {
            return b(t, e, r)
        ...
        g(ge, r.year, r.month, r.date), r.droppable && t(document).bind("dragstart",function (e,
                                                                                              n) {
    ...
    function o(n, r) {
        ...
        function f(t) {
            ...
            for (e = 0; r > e; e++)n = W[e], n._id == t._id && n != t && (n.start = new Date(+n.start + o), n.end = t.end ? n.end ? new Date(+n.end + i) : new Date(+a(n) + i) : null, n.title = t.title, n.eId = t.eId, n.entity_type = t.entity_type, n.url = t.url, n.allDay = t.allDay, n.className = t.className, n.editable = t.editable, n.color = t.color, n.backgroundColor = t.backgroundColor, n.borderColor = t.borderColor, n.textColor = t.textColor, b(n));
            b(t), k(W)
        }
    ...
    function Z(e, n, r) {
        ...
        function s() {
            var n = c();
            L && L.remove(), L = t(n).appendTo(e), _ = L.find("thead"), q = _.find(".fc-day-header"), j = L.find("tbody"), I = j.find("tr"), X = j.find(".fc-day"), J = I.find("td:first-child"), V = I.eq(0).find(".fc-day > div"), U = I.eq(0).find(".fc-day-content > div"), P(_.add(_.find("tr"))), P(I), I.eq(0).addClass("fc-first"), I.filter(":last").addClass("fc-last"), X.each(function (e,
                                                                                                                                                                                                                                                                                                                                                                                                    n) {
        ...
        function g(e) {
            ...
            "variable" == be("weekMode") ? n = r = Math.floor(o / (1 == ee ? 2 : 6)) : (n = Math.floor(o / ee), r = o - n * (ee - 1)), J.each(function (e,
                                                                                                                                                        o) {
    ...
    function K(n, r, a) {
        ...
        function b(e) {
            ...
            me && (n = n.add(me.find("th:first"))), n = n.add(Me.find("th:first")), ke = 0, T(n.width("").each(function (e,
                                                                                                                         n) {
    ...
    function te() {
        ...
        function v(t, e, n) {
            ...
            e.draggable({opacity: y("dragOpacity", "month"), revertDuration: y("dragRevertDuration"), start: function (n,
                                                                                                                       p) {
                b("eventDragStart", e, t, n, p), G(t, e), a = e.width(), u.start(function (n,
                                                                                           a) {
                    if (te(), n) {
                        o = !1;
        ...
        function g(t, e, n) {
            ...
            e.draggable({scroll: !1, grid: [S, x], axis: 1 == T ? "y" : !1, opacity: y("dragOpacity"), revertDuration: y("dragRevertDuration"), start: function (n,
                                                                                                                                                                 r) {
        ...
        function p(t, e, n) {
            var r, a, o = X(), i = J();
            e.resizable({handles: {s: ".ui-resizable-handle"}, grid: o, start: function (n,
                                                                                         o) {
    ...
    function oe() {
        ...
        function r(e, n, r) {
            ...
            return i(v), o = s(v), d[0].innerHTML = o, l = d.children(), n && c.append(l), u(v, l), se(v, function (t,
                                                                                                                    e) {
                t.hsides = x(e, !0)
            }), se(v, function (t, e) {
        ...
        function w(t, e) {
            var n, r = te();
            e.draggable({delay: 50, opacity: S("dragOpacity"), revertDuration: S("dragRevertDuration"), start: function (a,
                                                                                                                         o) {
                k("eventDragStart", e, t, a, o), A(t, e), r.start(function (r,
                                                                            a,
                                                                            o,
                                                                            i) {
        ...
        function M(e, r, a) {
            ...
            B(r), r.mousedown(function (t) {
                ...
                if (1 == o.which) {
                    ...
                    K(), t("body").css("cursor", i + "-resize").one("mouseup", s), k("eventResizeStart", this, e, o), u.start(function (r,
                                                                                                                                        o) {
                        if (r) {
                            var s = ae(o), c = ae(r);
    ...
    t.fn.fullCalendar = function (n) {
        ...
        return delete n.eventSources, n.events && (i.push(n.events), delete n.events), n = t.extend(!0, {}, he, n.isRTL || n.isRTL === e && he.isRTL ? ge : {}, n), this.each(function (e,
                                                                                                                                                                                        a) {
