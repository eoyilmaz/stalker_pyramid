(function (b) {
    ...
    b.extend(a.prototype, {initImage: function (c, d) {
        ...
        this.options.image.before_change = this.options.image.before_change || function (f,
                                                                                         g) {
            var d = f[0];
            if (typeof d === "string") {
...
(function (a) {
    ...
    a.extend(b.prototype, {render: function () {
        ...
        this.$tpl.parent().find(".wysiwyg-editor").show().ace_wysiwyg({toolbar: [
                'font',
                null,
                'fontSize',
                null,
...
(function (b) {
    ...
    b.extend(a.prototype, {initSlider: function (c, d) {
        ...
        if (this.$input.is(":visible")) {
            ...
            var d = b.extend(this.options.slider, {value: f, slide: function (g,
                                                                              h) {
