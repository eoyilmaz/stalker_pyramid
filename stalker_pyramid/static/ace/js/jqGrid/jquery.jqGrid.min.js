...
(function (b) {
    ...
    b.extend(b.jgrid, {version: "4.5.2", htmlDecode: function (b) {
        ...
        var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, j = "string" === typeof f ?
            ...
            return a
        }, g = {m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0}, h = 0, i, k, h = function (a,
                                                                                         b) {
            ...
            if (!this.grid) {
                var e = b.extend(!0, {url: "", height: 150, page: 1, rowNum: 20, rowTotal: null, records: 0, pager: "", pgbuttons: !0, pginput: !0, colModel: [], rowList: [], colNames: [], sortorder: "asc", sortname: "", datatype: "xml", mtype: "GET",
                    ...
                    scrollrows: !1, autowidth: !1, scrollOffset: 18, cellLayout: 5, subGridWidth: 20, multiselectWidth: 20, gridview: !1, rownumWidth: 25, rownumbers: !1, pagerpos: "center", recordpos: "right", footerrow: !1, userDataOnFooter: !1, hoverrows: !0, altclass: "ui-priority-secondary", viewsortcols: [!1, "vertical", !0], resizeclass: "", autoencode: !1, remapColumns: [], ajaxGridOptions: {}, direction: "ltr", toppager: !1, headertitles: !1, scrollTimeout: 40, data: [], _index: {}, grouping: !1, groupingView: {groupField: [], groupOrder: [], groupText: [], groupColumnShow: [],
                        groupSummary: [], showSummaryOnHide: !1, sortitems: [], sortnames: [], summary: [], summaryval: [], plusicon: "ui-icon-circlesmall-plus", minusicon: "ui-icon-circlesmall-minus", displayField: []}, ignoreCase: !1, cmTemplate: {}, idPrefix: "", multiSort: !1}, b.jgrid.defaults, d || {}), a = this, c = {headers: [], cols: [], footers: [], dragStart: function (c,
                                                                                                                                                                                                                                                                                                                                                                                               d,
                                                                                                                                                                                                                                                                                                                                                                                               g) {
                ...
                if ("TABLE" !== this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        var o = function (a, b) {
                            ...
                            if (!d || !d.length)d = b.map(a.p.colModel, function (a,
                                                                                  b) {
                                return b
                            });
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                k = ("" + t).indexOf("[") === -1 ? p.length ? function (a,
                                                                                        c) {
                                    return b(t, a).text() || c
                                } : function (a, c) {
                                    ...
                                    switch (g) {
                                        ...
                                        case "script":
                                            b.ajax(b.extend({url: a.p.url, type: a.p.mtype, dataType: g, data: b.isFunction(a.p.serializeGridData) ?
                                                a.p.serializeGridData.call(a, a.p.postData) : a.p.postData, success: function (e,
                                                                                                                               f,
                                                                                                                               h) {
...
(function (a) {
    ...
    a.fn.fmatter.rowactions = function (c) {
        ...
        b = {keys: i.keys, oneditfunc: i.onEdit, successfunc: i.onSuccess, url: i.url, extraparam: i.extraparam, aftersavefunc: function (b,
                                                                                                                                          c) {
    ...
    a.unformat.select = function (c, b, d, e) {
        ...
        if (e.value) {
            ...
            if (a.fmatter.isString(g)) {
                ...
                for (k = 0; k < j.length; k++)if (f = j[k].split(b), 2 < f.length && (f[1] = a.map(f,function (a,
                                                                                                               b) {
                    if (b > 0)return a
    ...
    a.jgrid.extend({getColProp: function (a) {
        ...
        setGridState: function (b) {
                ...
                if (!this.ftoolbar) {
                    var f = function () {
                        ...
                        if (!0 === b.stringResult || "local" === c.p.datatype) {
                            ...
                            a.each(["searchField", "searchString", "searchOper"], function (a,
                                                                                            b) {
            ...
            return this.each(function () {
                ...
                a(this).bind("jqGridResizeStop.setGroupHeaders", function (a,
                                                                           b,
                                                                           c) {
                ...
                if (this.grid) {
                    ...
                    if (!(!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable ||
                        ...
                        if (0 <= j && h) {
                            ...
                            a(b).bind("jqGridResizeStop.setFrozenColumns", function (c,
                                                                                     d,
                                                                                     e) {
                            ...
                            a(b).bind("jqGridOnSortCol.setFrozenColumns", function (c,
                                                                                    d,
                                                                                    e) {
            ...
            if (e.grid) {
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])c(a("#fbox_" + a.jgrid.jqID(+e.p.id))); else {
                    ...
                    b.tmplNames && b.tmplNames.length && (k = !0, f = b.tmplLabel, f += "<select class='ui-template'>",
                        f += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a,
                                                                                                       b) {
    ...
    a.jgrid.extend({editRow: function (c, b, e, o, l, g, n, h, f) {
                    ...
                    switch (k.edittype) {
                        ...
                        case "select":
                            if (k.editoptions.multiple) {
                                ...
                                i[m] = a(b).val();
                                i[m] = i[m] ? i[m].join(",") : "";
                                a("select option:selected", this).each(function (d,
                                                                                 c) {
                                    g[d] = a(c).text()
                                });
                                w[m] = g.join(",")
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                !0 === b.restoreAfterSelect && (o = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow : !1, e.p.beforeSelectRow = function (c,
                                                                                                                                                  f) {
                    var g = true;
    ...
    b.jgrid.extend({setSubGrid: function () {
        ...
        return this.each(function () {
            ...
            if (a.grid) {
                ...
                !0 === a.p.subGridOptions.expandOnLoad && b(a.rows).filter(".jqgrow").each(function (a,
                                                                                                     c) {
                    b(c.cells[0]).click()
                });
...
(function (d) {
    d.extend(d.jgrid, {template: function (b) {
        ...
        null == b && (b = "");
        return b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function (e,
                                                                                    b) {
            ...
            switch (a.imptype) {
                case "xml":
                    c.ajax(c.extend({url: a.impurl,
                        type: a.mtype, data: a.impData, dataType: "xml", complete: function (b,
                                                                                             g) {
